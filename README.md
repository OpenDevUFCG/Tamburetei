...
| **visaoGeralEDicas.md**   | Esse arquivo contém três seções: _Ementa_, uma lista dos tópicos formalmente abordados na disciplina, _Visão Geral_, uma breve descrição da disciplina e de sua importância para a carreira do cientista da computação, e _Dicas_, uma lista de dicas úteis para aqueles que irão começar a cursar a disciplina. |

Para facilitar a criação dessa estrutura, você pode utilizar um _script_ que disponibilizamos. Para usá-lo, basta ter Python instalado em sua máquina. Dito isso, navegue até a pasta [scripts](scripts/) em seu terminal:
